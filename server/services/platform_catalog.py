...
FAMILY_METADATA: dict[ProductFamily, dict[str, object]] = {
    ProductFamily.KEYBOARD: {
        ...
        "status": "enabled",
        "readiness_tier": "proven",
        "readiness_label": "Safest path",
        "readiness_detail": "Deepest layout, validation, electronics, and export evidence today.",
        "capabilities": [
            "switch_catalog",
            "layout_editing",
            "keycap_generation",
    ...
    ProductFamily.MACROPAD: {
        ...
        "readiness_label": "Alpha path",
        "readiness_detail": "Shares the keyboard proof stack, with smaller-grid constraints still maturing.",
        "capabilities": [
            "switch_catalog",
            "layout_editing",
            "keycap_generation",
    ...
    ProductFamily.STREAMDECK: {
        ...
        "readiness_tier": "alpha",
        "readiness_label": "Alpha path",
        "readiness_detail": "Good panel and control proof; display and labeling evidence is still early.",
        "capabilities": [
            "switch_catalog",
            "layout_editing",
            "keycap_generation",
    ...
    ProductFamily.MIDI: {
        ...
        "status": "enabled",
        "readiness_tier": "proof",
        "readiness_label": "Proof path",
        "readiness_detail": "Mapping and control workflow proof before a full fabrication package.",
        "capabilities": [
            "switch_catalog",
            "layout_editing",
            "keycap_generation",
    ...
    ProductFamily.GAMEPAD: {
        ...
        "readiness_tier": "proof",
        "readiness_label": "Proof path",
        "readiness_detail": "HID layout proof with manufacturing coverage still under active buildout.",
        "capabilities": [
            "layout_editing",
            "button_mapping",
            "panel_geometry",
    ...
    ProductFamily.PEDAL_CONTROLLER: {
        ...
        "readiness_tier": "proof",
        "readiness_label": "Proof path",
        "readiness_detail": "Visible as an expansion path while manufacturable proof coverage matures.",
        "capabilities": [
            "layout_editing",
            "button_mapping",
            "expression_mapping",
    ...
    for family, meta in FAMILY_METADATA.items():
        ...
        manifests.append(
            ProductFamilyManifest(
                ...
                readiness_tier=str(meta.get("readiness_tier", "planned")),
                readiness_label=str(meta.get("readiness_label", "")),
                readiness_detail=str(meta.get("readiness_detail", "")),
